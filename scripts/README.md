...
This directory contains scripts to help you register, build, and sort components in the PetalUI project.
...
./scripts/register-component.ps1 "components/petalui/basics/buttons/my-button.tsx"

# Using the npm script
npm run add-component "components/petalui/basics/buttons/my-button.tsx"
# or with bun
bun run add-component "components/petalui/basics/buttons/my-button.tsx"
```
...
# Using the script directly
./scripts/register-component.sh "components/petalui/basics/buttons/my-button.tsx"
```

## Example

```bash
bun run add-component components/petalui/basics/buttons/btn-gradient1.tsx
```

## What the Script Does

1. Identifies the type of component based on its path:
   - Components in `/components/petalui/` are registered as `registry:block`
